...
var _default = {
  ...
  faceInsightsServer: {
    ...
    prod: "http://ec2-35-164-53-88.us-west-2.compute.amazonaws.com:5000" // NOTE: AWS API gateway doesn't allow multipart form data ATM; using http instead for now
