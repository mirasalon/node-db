...
var _nodeFetcher = require("./nodeFetcher");
...
test("basic enhancer test", function () {
  ...
  var ConnectedComponent = (0, _nodeFetcher.withProduct)(SampleComponent);
...
test("full enhancer test", function () {
  ...
  _ramda.default.keys(nodeSet).map(function (nodeType) {
    var ConnectedComponent = (0, _nodeFetcher.withNode)(nodeType)(SampleComponent);
    nodeSet[nodeType].map(function (node) {
