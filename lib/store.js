...
var remove = function remove(state, _ref2) {
  ...
  return _seamlessImmutable.default.from(
    _objectSpread({}, state, {
...
var nodeDBReducer = (0, _reduxsauce.createReducer)(
  INITIAL_STATE,
  ((_createReducer = {}),
  _defineProperty(_createReducer, Types.INSERT, insert),
  _defineProperty(_createReducer, Types.REMOVE, remove),
  _createReducer)
); //#############################################################################
...
var createNodeDBReducer = function createNodeDBReducer(indexSpec) {
  ...
  return (0, _reduxsauce.createReducer)(
    _seamlessImmutable.default.from({
      nodes: {},
      indices: {},
      indexSpec: indexSpec
    }),
    ((_createReducer2 = {}),
    _defineProperty(_createReducer2, Types.INSERT, insert),
    _defineProperty(_createReducer2, Types.REMOVE, remove),
    _createReducer2)
  );
};
